<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:60:"/home/www/xcx/public/../application/admin/view/pic/edit.html";i:1557143927;s:55:"/home/www/xcx/application/admin/view/layout/layout.html";i:1555386459;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8"/>
...
<form action='/pic/<?php echo $res['id']; ?>' method='post'>
	<input type='hidden' name='_method' value='put'>
     <section>
      <ul class="ulColumn2">
       <li>
        <span class="item_name" style="width:120px;">图片名称：</span>
        <input type="text" name='img_title'value='<?php echo $res['img_title']; ?>'  class="textbox textbox_295" placeholder="图片名称..."/>
       </li>
       <li>
        <span class="item_name" style="width:120px;">图片顺序：</span>
        <input type="text" name='img_order' value='<?php echo $res['img_order']; ?>' class="textbox" placeholder="图片顺序..."/>
       </li>
       <li>
        <span class="item_name" style="width:120px;">是否展示：</span>
        <label class="single_selection"><input type="radio" <?php echo $res['is_show']==1?'checked':''; ?> value='1' name="is_show"/>是</label>
        <label class="single_selection"><input type="radio" <?php echo $res['is_show']==0?'checked':''; ?> value='0' name="is_show"/>否</label>
       </li>
       <li>
        <span class="item_name" style="width:120px;">上传图片：</span>
        <label id="filePicker">选择图片</label>
	<img src='<?php echo $res['img_url']; ?>' style='width:200px;height:100pxi'  id='img'>
	<input type='hidden' name='img_url' value='<?php echo $res['img_url']; ?>' id='img_url'>
       </li>
       <li>
